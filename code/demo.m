...
specific = "vert_xiphoid/demo/"; % specific subdirectory
file = "Raw Data.csv"; % file of interest (if we desire a specific file)
...
%% RR estimation
max_n_imfs = 6;
[rr_est, resp_imfs] = estimate_RR(clean_data.accel_y, clean_data.time, f_resample, max_n_imfs, "estrada", 1);